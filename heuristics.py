...
# It chooses the variablw with the fewest remaining legal values and also incorporates the tie breaking rule
# and returns the first value based on the ordering
...
# Implementation of the Least-Constraining-Value heuristic for value ordering
# It sorts the domains by how mant conflicts the assignment creates in increasing order
# and returns a list of domain vlaues 
